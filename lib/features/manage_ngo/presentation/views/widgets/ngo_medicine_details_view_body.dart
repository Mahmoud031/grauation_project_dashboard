...
class NgoMedicineDetailsViewBody extends StatelessWidget {
  final String ngoUId;
  const NgoMedicineDetailsViewBody({super.key, required this.ngoUId});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (docs.isEmpty) {
          return const Center(child: Text('No medicines found for this NGO.'));
        }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Donor Name: ${clean(data['donorName'])}'),
                    Text('Donor Details: ${clean(data['details'])}'),
                    const SizedBox(height: 4),
